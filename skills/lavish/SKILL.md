...
- Lavish automatically snapshots distinct HTML changes behind the same stable board URL. Run `npx -y lavish-axi snapshot <html-file> [--label "..."]` to save or label a deliberate review milestone; identical HTML is deduplicated
